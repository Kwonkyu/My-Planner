...
public class ListViewBtnAdapter extends ArrayAdapter implements View.OnClickListener {
    ...
    public ListViewBtnAdapter(Context context, int resource, ArrayList<String> list, ListBtnClickListener clickListener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final String listViewItem = (String)getItem(position);

        // 아이템 내 각 위젯에 데이터 반영
        textTextView.setText(listViewItem);


        Button button1 = (Button) convertView.findViewById(R.id.list_item_delete_button);
